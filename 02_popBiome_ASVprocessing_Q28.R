...
"data/filtered_outputs/myco.04.12.a.R1.filt.fastq.gz" %in% post_filter_fnFs # should be F
"data/filtered_outputs/myco.03.12.d.R2.filt.fastq.gz" %in% post_filter_fnRs # should be F
"data/filtered_outputs/myco.04.12.a.R1.filt.fastq.gz" %in% post_filter_fnFs # should be F
"data/filtered_outputs/myco.03.12.d.R2.filt.fastq.gz" %in% post_filter_fnRs # should be F
"data/filtered_outputs/myco.03.06.a.R2.filt.fastq.gz" %in% post_filter_fnRs # should be T
...
jpeg(filename="outputs/Q28/Error_F_plots_Q28.jpeg", width = 4, height = 4, units = 'in', res = 300)
err_F_plot
dev.off()
err_R_plot <- plotErrors(errR, nominalQ = TRUE)
jpeg(filename="outputs/Q28/Error_R_plots_Q28.jpeg", width = 4, height = 4, units = 'in', res = 300)
err_R_plot
dev.off()
...
Q28_track_head <- capture.output(head(track_df,100), file = "outputs/Q28/Q28_stats.txt", append = TRUE)
Q28_track_head
